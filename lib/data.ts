...
// ============================================================
// Cautionary Tales — external events informing AISPEG's approach
// ============================================================

export interface CautionaryTale {
  id: string;
  title: string;
  summary: string;
  source: {
  ...
  whatHappened: string;
  whyItMatters: string;
  howAispegDiffers: string[];
}

export const cautionaryTales: CautionaryTale[] = [
  {
    id: "lovable-vibe-coding-2026",
    title: "Vibe coding without institutional guardrails",
    summary:
      "Lovable, an AI-powered coding platform valued at $6.6B, left thousands of its users' projects exposed for 48 days after closing a bug report without escalation. Three documented breaches revealed source code, database credentials, and real user records.",
    source: {
      outlet: "The Next Web",
      headline:
    ...
    keyStats: [
      ...
      {
        value: "40–62%",
        label: "AI-generated code found to contain vulnerabilities",
      },
      {
        value: "91.5%",
        label: "Vibe-coded apps with at least one AI hallucination-related flaw in Q1 2026",
      },
      {
        value: "87%",
      ...
      {
        value: "60%",
        label: "Projected share of all new code that will be AI-generated by year-end 2026",
      },
    ],
    keyQuote:
      "The real risk of vibe coding isn't AI writing insecure code. It's humans shipping code they never had a chance to secure.",
    whatHappened:
      "Lovable generates full-stack web apps from natural-language prompts. A broken-authorization vulnerability allowed thousands of hosted projects to leak source code, database credentials, and real user data. Among the affected: a Connected Women in AI project exposing names, job titles, LinkedIn profiles, and Stripe IDs; students from UC Berkeley and UC Davis; and employees at Nvidia, Microsoft, Uber, and Spotify. The bug was reported and initially closed without escalation — the exposure window was 48 days.",
    whyItMatters:
      "This is a preview of what happens when AI-assisted application development scales across an institution without governance. No named owner. No review gate. No security standard. No audit trail. The application ships, the exposure ships with it, and the institution finds out after.",
    howAispegDiffers: [
      "Every AISPEG-coordinated intervention names an operational owner who is accountable for the outcome, not just the code.",
      "New UI applications start from TEMPLATE-app — JWT, RBAC, dependency scanning, CycloneDX SBOM, and institutional review checklist baked in from day one.",
      "OIT holds a standards-review gate; IIDS-built tooling is evaluated before it propagates as an endorsed UI standard.",
      "All AI inference for UI apps routes through MindRouter, which maintains a full audit log of prompts, responses, and artifacts for review.",
      "The inventory at aispeg.insight.uidaho.edu is institutional visibility: shadow AI work gets surfaced, not hidden, so a 48-day exposure isn't possible under AISPEG's governance posture.",
    ],
  },
];
